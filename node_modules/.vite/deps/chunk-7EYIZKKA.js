...
function defineComponent2(options) {
  ...
  if (options._setup) {
    options.props = propsFactory((_b = options.props) != null ? _b : {}, toKebabCase(options.name))();
      ...
      const _props = new Proxy(props, {
        get(target, prop) {
          ...
          if (typeof prop === "string" && !propIsDefined(vm.vnode, prop)) {
            return (_d = (_c = (_a2 = componentDefaults.value) == null ? void 0 : _a2[prop]) != null ? _c : (_b2 = defaults.value.global) == null ? void 0 : _b2[prop]) != null ? _d : propValue;
          }
          return propValue;
        }
      });
...
//# sourceMappingURL=chunk-7EYIZKKA.js.map
